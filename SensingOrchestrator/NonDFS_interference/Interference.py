...
import Interference_epy_block_0 as epy_block_0  # embedded python block
import Interference_epy_block_1 as epy_block_1  # embedded python block
import Interference_epy_block_2 as epy_block_2  # embedded python block
import Interference_epy_block_3 as epy_block_3  # embedded python block
...
class Interference(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Interference")
        ...
        self.epy_block_7 = epy_block_7.blk(example_param=1.0, sample_rate=samp_rate, mean_interval_seconds=300, inject_duration_seconds=10, log_path="Injection_2_4.jsonl", log_every_injection="True", output_when_idle="Zeros", pure_inject_enabled=True, pure_injection_probability=1, pure_inject_duration_seconds=20)
        self.epy_block_3 = epy_block_3.blk(samp_rate=4000000.0, num_hoppers=5, hop_rate=800, num_channels=40, tone_bw=300000, gain=1.0)
        self.epy_block_2 = epy_block_2.blk(samp_rate=4000000.0, ble_bw=1000000.0, hop_rate=1600, burst_ms=4, gain=0.8)
        self.epy_block_1 = epy_block_1.blk(samp_rate=int(samp_rate), center_freq=int(2.44e9), chip_rate=2000000.0, gain=1.0)
        self.epy_block_0 = epy_block_0.blk(samp_rate=samp_rate, burst_rate=100, duty_cycle=0.3, noise_amp=0.8, wobble_freq=2.0, wobble_depth=0.15, hump_width=0.35, hump_gain=3.0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.epy_block_0, 0), (self.epy_block_7, 0))
        self.connect((self.epy_block_1, 0), (self.epy_block_7, 1))
        self.connect((self.epy_block_2, 0), (self.epy_block_7, 2))
        self.connect((self.epy_block_3, 0), (self.epy_block_7, 3))
        self.connect((self.epy_block_7, 0), (self.iio_pluto_sink_0, 0))
        self.connect((self.iio_pluto_source_0, 0), (self.qtgui_eye_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.epy_block_1.samp_rate = int(self.samp_rate)
