...
import Test_epy_block_4_0ap1 as epy_block_4_0  # embedded python block
import Test_epy_block_4_0_0ap1 as epy_block_4_0_0  # embedded python block
...
class Test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.NON_DFS_5_GHz = NON_DFS_5_GHz = [44,48, 149]
        ...
        #self.iio_pluto_source_0 = iio.fmcomms2_source_fc32(uri = 'ip:192.168.2.1', bufsize = 4046, buffer_count = 2, cyclic = False)
