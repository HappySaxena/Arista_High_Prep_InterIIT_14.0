...
import Test_epy_block_4_0ap2 as epy_block_4_0  # embedded python block
import Test_epy_block_4_0_0ap2 as epy_block_4_0_0  # embedded python block
...
class Test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('ip:192.168.3.1' if 'ip:192.168.3.1' else iio.get_pluto_uri(), [True, True], 4096)
